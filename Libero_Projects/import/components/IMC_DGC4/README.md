...
* **miv-rv32i-systick-blinky.hex**: A Hex program configured to run from LSRAM's address (0x8000_0000). MIV_RV32 reset vector is setup to boot from 0x8000_0000.
    ...
    > The example hex program was created using  miv-rv32i-systick-blinky in release mode (miv32imc-Release). For more information about the project go to bare metal example: [miv-rv32i-systick-blinky](https://github.com/Mi-V-Ecosystem/mi-v-ecosystem.github.io/blob/main/_redirects/mi-v-soft-risc-v/bare-metal-examples/miv-rv32i-systick-blinky.md)
