...
sd_create_scalar_port -sd_name ${sd_name} -port_name {PF_IO_SPI_HOLDn} -port_direction {OUT}
...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {PF_IO_SPI_HOLDn} -value {VCC}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"FLASH_SCK" "MIV_ESS_C0_0:SPI_SCK" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FLASH_SDI" "MIV_ESS_C0_0:SPI_SDI" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FLASH_SDO" "MIV_ESS_C0_0:SPI_SDO" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FLASH_SS" "MIV_ESS_C0_0:SPI_SS" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"MIV_ESS_C0_0:SPI_IRQ" "MIV_RV32_C0_0:MSYS_EI[0:0]" }
