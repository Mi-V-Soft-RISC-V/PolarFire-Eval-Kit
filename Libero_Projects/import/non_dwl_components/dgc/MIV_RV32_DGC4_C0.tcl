# Exporting Component Description of MIV_RV32_DGC4_C0 to TCL
# Family: PolarFire
# Part Number: MPF300T-FCG1152I
# Create and Configure the core component MIV_RV32_DGC4_C0
create_and_configure_core -core_vlnv {Microsemi:MiV:MIV_RV32:3.1.100} -component_name {MIV_RV32_DGC4_C0} -params {\
...
# Exporting Component Description of MIV_RV32_DGC4_C0 to TCL done
