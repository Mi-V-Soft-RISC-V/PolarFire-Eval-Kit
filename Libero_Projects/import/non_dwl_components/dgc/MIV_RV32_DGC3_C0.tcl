...
create_and_configure_core -core_vlnv {Microsemi:MiV:MIV_RV32:3.1.100} -component_name {MIV_RV32_DGC3_C0} -params {\
...
# Exporting Component Description of MIV_RV32_DGC3_C0 to TCL done
