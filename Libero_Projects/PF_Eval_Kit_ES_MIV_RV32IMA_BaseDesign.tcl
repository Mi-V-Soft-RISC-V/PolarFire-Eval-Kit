...
set Libero_project_name_CFG1 PF_Eval_Kit_ES_MIV_RV32IMA_CFG1_BaseDesign

set project_folder_name_CFG2 MIV_CFG2_BD
set project_dir_CFG2 "./$project_folder_name_CFG2"
set Libero_project_name_CFG2 PF_Eval_Kit_ES_MIV_RV32IMA_CFG2_BaseDesign
...
proc increase_loop_limit { }\
{
	#Increase the loop limit in Synplify
...
if {"$design_flow_stage" == "SYNTHESIZE"} then {
	...
	if {"$config" == "CFG1"} then {
		export_prog_job \
			-job_file_name {PF_Eval_Kit_ES_MIV_RV32IMA_CFG1_BaseDesign} \
		...
		export_prog_job \
			-job_file_name {PF_Eval_Kit_ES_MIV_RV32IMA_CFG2_BaseDesign} \
