...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\esip_projects\FPGA_BU_ESIP\gh-libsd-pf-eval\Libero_Projects\MIV_Legacy_CFG1_BD\synthesis\BaseDesign.vm"}
set_compile_info \
    -category {"Options"} \
    -name {"Limit the number of high fanout nets to display to"} \
    -value {"10"}
compile \
    -desdir {C:\esip_projects\FPGA_BU_ESIP\gh-libsd-pf-eval\Libero_Projects\MIV_Legacy_CFG1_BD\designer\BaseDesign} \
    -design BaseDesign \
    -fam PolarFire \
    -die PA5M300TS \
    -pkg fcg1152 \
