...
This folder contains Tcl scripts that build Libero SoC v2025.1 MIV_ESS DGC1 design project for the PolarFire Eval Kit. The script is executed in Libero SoC to generate the sample design. 
