...
This folder contains Tcl scripts that build Libero SoC v2025.2 MIV_ESS DGC4 design project for the PolarFire Eval Kit. The script is executed in Libero SoC to generate the sample design. 
> This design is compatible with Libero SoC v2025.2. Using older versions of Libero SoC will result in errors.
